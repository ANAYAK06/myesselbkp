<%@ Page Title="Customer Retention Verification" Language="C#" MasterPageFile="~/Essel.master" AutoEventWireup="true"
    CodeFile="CustomerRetentionVerification.aspx.cs" Inherits="CustomerRetentionVerification" %>
                            ...
                            <tr align="center">
                                <td>
                                    <table style="width: 750px;">
                                        <tr align="center">
                                            <th>
                                                <asp:Label ID="Label5" CssClass="esfmhead" runat="server" Text=" Verify Client Retention Payments"></asp:Label>
                                            </th>
                                        </tr>
                                        <tr align="center">
                                            <td>
                                    ...
                                    <table class="estbl" width="745px" id="tblinvoice" runat="server">
                                        <tr>
                                            <th align="center">
                                                Verify Client Retention Invoices
                                            </th>
                                        </tr>
                                                ...
                                                <table>
                                                    <asp:GridView ID="Gvverification" Width="100%" runat="server" AutoGenerateColumns="false"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="retention_balance" HeaderText="Retention Amount" DataFormatString="{0:n}"
                                                                ItemStyle-HorizontalAlign="Center" />
                                                            <asp:BoundField DataField="Credit" HeaderText="Retention Paid Amount" DataFormatString="{0:n}"
                                                                ItemStyle-HorizontalAlign="Center" />
                                                        </Columns>
                                                    </asp:GridView>
                                                </table>
