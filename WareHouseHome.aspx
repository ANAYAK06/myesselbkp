<%@ Page Language="C#" MasterPageFile="~/Essel.master" AutoEventWireup="true" CodeFile="WareHouseHome.aspx.cs"
    Inherits="WareHouseHome" Title="WareHouse Home - Essel Projects Pvt. Ltd." %>

<%@ Register Src="~/WareHouseVerticalMenu.ascx" TagName="Menu" TagPrefix="AccountMenu" %>
        ...
        <tr>
            ...
            <td valign="top">
                <table>
                    <tr>
                        <td style="width: 740px">
                            <asp:Label ID="lblscroll" Width="740px" Font-Bold="true" Font-Size="Small" runat="server"></asp:Label>
                        </td>
                    </tr>
                </table>
                <table id="_terp_list_grid" class="grid" width="740px" cellspacing="0" cellpadding="0">
                    ...
                    <asp:Button ID="Button1" runat="server" Text="Button" PostBackUrl="~/StockUpdation.aspx"
                        Style="display: none;" />
                    <asp:Button ID="Button2" runat="server" Text="Button" PostBackUrl="~/Issue.aspx"
                        Style="display: none;" />
                    <asp:Button ID="Button3" runat="server" Text="Button" PostBackUrl="~/Transfer.aspx"
                        Style="display: none;" />
                </table>
            </td>
        </tr>
