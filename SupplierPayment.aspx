<%@ Page Title="" Language="C#" MasterPageFile="~/Essel.master" AutoEventWireup="true"
    CodeFile="SupplierPayment.aspx.cs" Inherits="SupplierPayment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <table class="estbl" width="745px">
                            ...
                            <tr id="trselection" runat="server">
                                <td>
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:DropDownList ID="ddlpo" runat="server" ToolTip="Po" Width="120px" CssClass="esddown">
                                    </asp:DropDownList>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <tr id="trgrid" runat="server">
                                <td align="center" colspan="2">
                                    <asp:GridView ID="grd" runat="server" CssClass="mGrid" AllowPaging="false" AllowSorting="True"
                                        ...
                                        Font-Size="Small" OnSelectedIndexChanged="grd_SelectedIndexChanged">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtamt" CssClass="estbox" runat="server" ToolTip="Amount" Width="200px"
                                                    onkeyup="Amounvalidation(this.value);" onkeypress='return numericValidation(this);'></asp:TextBox><span
                                                        class="starSpan">*</span>
    ...
    <script type="text/javascript">
        ...
        function validate() {           
            var objs = new Array("<%=ddlservice.ClientID %>", "<%=ddlvendor.ClientID %>", "<%=ddlpo.ClientID %>"
