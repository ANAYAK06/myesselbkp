<%@ Page Title="" Language="C#" MasterPageFile="~/Essel.master" AutoEventWireup="true" CodeFile="CCAccrued.aspx.cs" Inherits="CCAccrued" %>
            ...
            <td valign="top">
                <table width="100%">
                    <tr>
                        <td>
                            <h1>
                                <a id="shortcut_add_remove" class="shortcut-remove"></a>CC accrued interest details <a class="help" href="" title=""><small>Help</small> </a>
                            </h1>
                            <table width="100%">
                                <tr>
                                    <td align="center">
                                                                                                ...
                                                                                                <asp:GridView ID="GridView3" BorderColor="White" Width="650px" runat="server" AutoGenerateColumns="false"
                                                                                                    ...
                                                                                                    <Columns>
                                                                                                        ...
                                                                                                        <asp:TemplateField HeaderText="CC Code">
                                                                                                            ...
                                                                                                            <FooterTemplate>
                                                                                                                ...
                                                                                                                <cc1:CascadingDropDown ID="CascadingDropDown5" runat="server" TargetControlID="ddlfooterCCcode"
                                                                                                                    ServicePath="cascadingDCA.asmx" Category="dd" LoadingText="Please Wait" ServiceMethod="CCAccrued"
                                                                                                        ...
                                                                                                        <asp:TemplateField HeaderText="Interest Rate">
                                                                                                            <ItemTemplate>
                                                                                                                <asp:Label ID="lbloverhead" runat="server" Text='<%#Eval("Interest_Rate")%>'></asp:Label>
                                                                                                            </ItemTemplate>
                                                                                                            <EditItemTemplate>
                                                                                                                <asp:TextBox ID="txtohead" runat="server" CssClass="estbox" Width="100px" Text='<%#Eval("Interest_Rate")%>'></asp:TextBox>
                                                                                                            </EditItemTemplate>
                                                                                                            <FooterTemplate>
                                                                                                                <asp:TextBox ID="txtoverhead" runat="server" CssClass="estbox" Width="100px"></asp:TextBox>
                                                                                                            </FooterTemplate>
                                                                                                        </asp:TemplateField>
                                                                                                        <asp:TemplateField HeaderText="Budget interest on negative cash status">
                                                                                                            <ItemTemplate>
                                                                                                                <asp:Label ID="lbldepreciation" runat="server" Text='<%#Eval("CC_AccruedValue")%>'></asp:Label>
                                                                                                            </ItemTemplate>
                                                                                                            <EditItemTemplate>
                                                                                                                <asp:TextBox ID="txtdep" runat="server" CssClass="estbox" Width="100px" Text='<%#Eval("CC_AccruedValue")%>'></asp:TextBox>
                                                                                                            </EditItemTemplate>
                                                                                                            <FooterTemplate>
