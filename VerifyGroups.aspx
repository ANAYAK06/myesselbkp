<%@ Page Title="Verify Group" Language="C#" MasterPageFile="~/Essel.master" AutoEventWireup="true"
    CodeFile="VerifyGroups.aspx.cs" Inherits="VerifyGroups" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function validate() {
            var GridView = document.getElementById("<%=gvgroups.ClientID %>");
            if (GridView != null) {
                                        ...
                                        <tr style="border: 1px solid #000">
                                            <td>
                                                <table>
                                                    <tr align="center">
                                                        <td colspan="2">
                                                            <asp:GridView ID="gvgroups" runat="server" AlternatingRowStyle-CssClass="grid-row grid-row-even"
                                                                AutoGenerateColumns="False" BorderColor="white" CssClass="grid-content" DataKeyNames="id,group_type"
                                                                GridLines="None" HeaderStyle-CssClass="grid-header" OnRowDeleting="gvgroups_RowDeleting"
                                                                PagerStyle-CssClass="grid pagerbar" RowStyle-CssClass=" grid-row char grid-row-odd"
                                                                ShowFooter="false" Width="680px" OnRowDataBound="gvgroups_RowDataBound">
                                                                <Columns>
                                                                    <asp:BoundField DataField="group_type" Visible="false" />
                                                                    <asp:TemplateField>
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:BoundField DataField="group_name" HeaderText="Group Name" ItemStyle-ForeColor="DarkBlue" />
                                                                    <asp:BoundField DataField="GrossProfitCalc" HeaderText="For Gross Profit Calculation" />
