<%@ Page Language="C#" MasterPageFile="~/Essel.master" AutoEventWireup="true" CodeFile="ViewsVendorPo.aspx.cs"
    Inherits="ViewsVendorPo" Title="Vendor DO/PO - Essel Projects Pvt.Ltd." %>
                                                                                                                                                                            ...
                                                                                                                                                                            <table id="Table2" width="100%" runat="server" class="pestbl" style="border: 1px solid #000">
                                                                                                                                                                                <tr style="border: 1px solid  #000;">
                                                                                                                                                                                    <td align="center" colspan="2">
                                                                                                                                                                                        ...
                                                                                                                                                                                        <br />
                                                                                                                                                                                        <%-- <asp:Label ID="lblspace" runat="server" Width="90px"></asp:Label>--%>
