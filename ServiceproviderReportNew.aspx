<%@ Page Title="" Language="C#" MasterPageFile="~/Essel.master" AutoEventWireup="true"
    CodeFile="ServiceproviderReportNew.aspx.cs" Inherits="ServiceproviderReportNew" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validate() {
            ...
            if (costcenter == "Select Cost Center") {
            ...
            else if (vendorid == "Select vendor") {
                                    ...
                                    <table width="750px" style="border: 1px solid #000" class="estbl">
                                        <tr>
                                            <th align="center" colspan="4">
                                                SERVICE PROVIDER PO REPORT NEW &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <asp:Button ID="btnoldreport" runat="server" CssClass="esbtn" Text="View Old Report"
                                                    OnClick="btnoldreport_Click" />
                                        </tr>
                                        <tr style="border: none">
                                            <td align="center" colspan="2" style="width:370">
                                                <asp:Label ID="lblcccode" CssClass="eslbl" Font-Size="Small" runat="server" Text="CC Code"></asp:Label>
                                                <asp:DropDownList ID="ddlcccode" runat="server" Width="275px" CssClass="esddown" AutoPostBack="true"
                                                ...
                                                <cc1:CascadingDropDown ID="Cascadingcccode" runat="server" TargetControlID="ddlcccode"
                                                    ServicePath="cascadingDCA.asmx" Category="cc" LoadingText="Please Wait" ServiceMethod="StoreCC2">
                                                </cc1:CascadingDropDown>
                                            </td>
                                            <td align="center" colspan="2" style="width:370">
                                                <asp:Label ID="Label1" CssClass="eslbl" runat="server" Text="DCA Code"></asp:Label>
                                                <asp:DropDownList ID="ddldca" runat="server" Width="320px" CssClass="esddown" AutoPostBack="true"
                                        ...
                                        <tr style="border: none" id="trdca" runat="server" >
                                            <td align="center" colspan="2" style="width:370">
                                                ...
                                                <asp:DropDownList ID="ddlvendor" Width="280px" CssClass="esddown" ToolTip="Select Vendor"
                                                    runat="server">
                                            ...
                                            <td align="center" colspan="2" style="width:370">
                                                ...
                                                <asp:DropDownList ID="Ddltype" Width="300px" CssClass="esddown" ToolTip="Select Vendor"
                                                ...
                                                <table id="_terp_list_grid" class="grid" width="100%" cellspacing="0" cellpadding="0">
                                                    <asp:GridView ID="GridView1" runat="server" CssClass="mGrid" AutoGenerateColumns="false"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="pono" ItemStyle-Width="40px" HeaderText="PONO" />
                                                            <asp:BoundField DataField="name" ItemStyle-Width="200px" HeaderText="VendorId/Name" />
                                                            <asp:BoundField DataField="po_date" ItemStyle-Width="130px" HeaderText="Date" />
                                                            <asp:BoundField DataField="po_value" ItemStyle-Width="80px" ItemStyle-HorizontalAlign="Right" HeaderText="Amount" DataFormatString="{0:0.00}" />
                                                            <asp:BoundField DataField="balance" ItemStyle-Width="80px" ItemStyle-HorizontalAlign="Right" HeaderText="Balance" DataFormatString="{0:0.00}" />
                                                            ...
                                                            <asp:BoundField DataField="Subdca_code" ItemStyle-Width="90px" HeaderText="SDCA Code" />
                                                                                                        ...
                                                                                                        <table id="Table4" width="100%" runat="server" class="pestbl" style="border: 1px solid #000">
                                                                                                            <tr style="border: 1px solid #000">
                                                                                                                <td colspan="2" style="border: 1px solid #000">
                                                                                                                    <asp:GridView CssClass="" ID="grdpoitems" Width="100%" runat="server" OnRowDataBound="grdpoitems_RowDataBound"
                                                                                                                        ...
                                                                                                                        <Columns>
                                                                                                                            ...
                                                                                                                            <asp:BoundField DataField="unit" HeaderText="Unit" HeaderStyle-BackColor="White" />
                                                                                                                            <asp:BoundField DataField="quantity" HeaderText="Quantity" HeaderStyle-BackColor="White" />
                                                                                                                            <asp:BoundField DataField="rate" HeaderText="Rate" HeaderStyle-BackColor="White" />
                                                                                                                            <asp:BoundField DataField="Amount" HeaderText="Amount" HeaderStyle-BackColor="White" />
                                                                                                                        </Columns>
                                                                                                                    </asp:GridView>
                                                                                                                    <asp:GridView CssClass="" ID="grdbill" Width="100%" runat="server" AutoGenerateColumns="false"
                                                                                                                        ...
                                                                                                                        <Columns>
                                                                                                                            ...
                                                                                                                            <asp:TemplateField ItemStyle-Font-Bold="true" HeaderText="PO Description" HeaderStyle-BackColor="White"
                                                                                                                                ...
                                                                                                                                <ItemTemplate>
                                                                                                                                    <asp:Label ID="txtremarks" BorderColor="White" Text='<%# Bind("remarks") %>' HtmlEncode="False"
                                                                                                                    ...
                                                                                                                    <asp:GridView CssClass="" ID="grdpoitemsamend" Width="100%" runat="server" OnRowDataBound="grdpoitemsamend_RowDataBound"
                                                                                                                        AutoGenerateColumns="false" ShowFooter="true">
                                                                                                                        <Columns>
                                                                                                                            <asp:TemplateField ItemStyle-Font-Bold="true" HeaderText="S.No" HeaderStyle-BackColor="White"
                                                                                                                                ItemStyle-Width="20px" ItemStyle-HorizontalAlign="Center">
                                                                                                                            ...
                                                                                                                            <asp:BoundField DataField="quantity" HeaderText="Quantity" HeaderStyle-BackColor="White" />
                                                                                                                            <asp:BoundField DataField="rate" HeaderText="Rate" HeaderStyle-BackColor="White" />
                                                                                                                            <asp:BoundField DataField="po_type" HeaderText="Type" HeaderStyle-BackColor="White" />
                                                                                                                            <asp:BoundField DataField="Amount" HeaderText="Amount" HeaderStyle-BackColor="White" />
                                                                                                                        </Columns>
                                                                                                                    </asp:GridView>
                                                                                                                    <asp:GridView CssClass="" ID="grdamendbill" Width="100%" runat="server" AutoGenerateColumns="false"
                                                                                                                        ...
                                                                                                                        <Columns>
                                                                                                                            <asp:TemplateField ItemStyle-Font-Bold="true" HeaderText="Amended Date" HeaderStyle-BackColor="White"
                                                                                                                                ...
                                                                                                                                ItemStyle-VerticalAlign="Middle">
                                                                                                                                <ItemTemplate>
                                                                                                                                    <asp:Label ID="lbldate" BorderColor="White" Text='<%# Bind("Amended_date") %>' runat="server"></asp:Label>
                                                                                                                                </ItemTemplate>
                                                                                                                            </asp:TemplateField>
                                                                                                            ...
                                                                                                            <tr style="padding: .3em; border: 1px #000000 solid;">
                                                                                                                <td colspan="1" align="center" style="width: 70%">
                                                                                                                    <asp:Label ID="Label2" runat="server" CssClass="eslbl" Width="100px" Font-Size="10px"
                                                                                                                    ...
                                                                                                                    <asp:Label ID="Label28" runat="server" CssClass="eslbl" Width="100px" Font-Size="10px"
                                                                                                                        Text="Amendment(+) Value:"></asp:Label>
                                                                                                                ...
                                                                                                                <td colspan="1" align="center" style="width: 30%">
                                                                                                                    <asp:Label ID="Label29" runat="server" CssClass="eslbl" Width="100px" Font-Size="10px"
