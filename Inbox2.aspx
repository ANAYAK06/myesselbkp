<%@ Page Title="" Language="C#" MasterPageFile="~/Essel.master" AutoEventWireup="true"
    CodeFile="Inbox2.aspx.cs" Inherits="Inbox2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function check() {
            ...
            if ((paymenttype != "Withdraw") && (paymenttype != "TDS")) {
                ...
                if (paymenttype != "Service Provider") {
                    if (parseInt(_Diff) < 0) {
                                                                ...
                                                                <div class="box-a list-a">
                                                                    <div class="inner" align="center">
                                                                                ...
                                                                                <tr>
                                                                                    <td class="grid-content" align="center">
                                                                                        <table id="_terp_list_grid" class="grid" width="100%" cellspacing="0" align="center"
                                                                                            ...
                                                                                            <asp:GridView ID="GridView1" runat="server" GridLines="None" Width="900px" AutoGenerateColumns="False"
                                                                                                ...
                                                                                                AllowPaging="True" DataKeyNames="id" OnDataBound="GridView1_DataBound" BorderColor="White"
                                                                                                OnSelectedIndexChanged="GridView1_SelectedIndexChanged1" EmptyDataText="There is no records"
                                                                                                ...
                                                                                                <Columns>
                                                                                                    ...
                                                                                                    <asp:BoundField DataField="amount" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:0.00}" HeaderText="Amount"
                                                                                                        ItemStyle-Width="75px" />
                                                                                                                                                                                        ...
                                                                                                                                                                                        <tbody>
                                                                                                                                                                                            <tr>
                                                                                                                                                                                                ...
                                                                                                                                                                                                <td width="21%" valign="middle" class="item item-char">
                                                                                                                                                                                                    <asp:TextBox ID="txtpaymentdate" onKeyDown="preventBackspace();" onpaste="return false;"
                                                                        ...
                                                                        <script type="text/javascript">
                                                                            ...
                                                                            function redirect() {
                                                                                window.location.href = "Raise inbox2.aspx";
