<%@ Page Language="C#" MasterPageFile="~/Essel.master" AutoEventWireup="true" CodeFile="frmUpdateCCBudget.aspx.cs"
    Inherits="Admin_frmUpdateCCBudget" EnableEventValidation="false" Title="Update CostCenter Budget - Essel Projects Pvt. Ltd." %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    function validate()
    {
        ...
        var objs=new Array("<%=ddlyear.ClientID %>","<%=ddlCCcode.ClientID %>","<%=txtBudget.ClientID %>");        
        if(!CheckInputs(objs))
        {
        return false;
        }        
                            ...
                            <table class="estbl" width="400px">
                                <tr style="border: 1px solid #000">
                                    <th valign="top" colspan="2" align="center">
                                        <asp:Label ID="Label4" CssClass="esfmhead" runat="server" Text="Update Cost Center Budget"></asp:Label>
                                    </th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td valign="top" align="left">
                                        ...
                                        <cc1:CascadingDropDown ID="CascadingDropDown2" runat="server" TargetControlID="ddlCCcode"
                                            ServicePath="EsselServices.asmx" Category="costcenter" LoadingText="Please Wait"
                                            ParentControlID="ddlyear" ServiceMethod="BudgetCC" PromptText="Select Cost Center">
                                        </cc1:CascadingDropDown>
