<%@ Page Language="C#" MasterPageFile="~/Essel.master" AutoEventWireup="true" CodeFile="DirectStockUpdation.aspx.cs"
    Inherits="DirectStockUpdation" Title="Stock Updation- Essel Projects Pvt.Ltd." %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script language="javascript">
        ...
        function searchvalidate() {
            ...
            var itemtype = document.getElementById("<%=ddlitemtype.ClientID %>").value;
            var itemtypectrl = document.getElementById("<%=ddlitemtype.ClientID %>");
    ...
    <script language="javascript">
        function checkitemtype() {
            GridView = document.getElementById("<%=GridView1.ClientID %>");
            var itemtypes = document.getElementById("<%=ddlitemtype.ClientID %>").value;
            var itemtypectrl = document.getElementById("<%=ddlitemtype.ClientID %>");
            if (GridView != null) {
                var itemtype = GridView.rows(1).cells(1).innerHTML.substring(0, 1);
                if (itemtypes != itemtype) {
                    alert("You are not able to add multiple DCA and SubDCA items");

                    itemtypectrl.focus();
                    document.getElementById("<%=ddlitemtype.ClientID %>").value = "Select Type";
                    return false;
                }
                                                            ...
                                                            <table style="width: 100%;">
                                                                <tr>
                                                                    <td style="width: 90%" valign="top" align="left">
                                                                        <h1>
                                                                            Direct Stock Updation<a class="help" href="" title="Direct Stock Updation"> <small>Help</small></a></h1>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td valign="top">
                                                                                                    ...
                                                                                                    <tbody>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td class="item item-selection" valign="middle">
                                                                                                                            <asp:TextBox ID="txtdate" onKeyDown="preventBackspace();" onpaste="return false;"
                                                                                                                                onkeypress="return false;" Font-Size="Small" runat="server" Style="width: 130px;
                                                                                                            ...
                                                                                                            <td style="width: 100px">
                                                                                                                <asp:DropDownList ID="ddlitemtype" CssClass="char" runat="server" AutoPostBack="true"
                                                                                                                    onchange="checkitemtype();" OnSelectedIndexChanged="ddlitemtype_SelectedIndexChanged">
                                                                                                    ...
                                                                                                    <asp:GridView ID="GridView1" BorderColor="White" runat="server" AutoGenerateColumns="False"
                                                                                                        ...
                                                                                                        <Columns>
                                                                                                            ...
                                                                                                            <asp:TemplateField HeaderText="Quantity">
                                                                                                                <ItemTemplate>
                                                                                                                    <asp:TextBox ID="txtqty" runat="server" Width="50px" onkeyup="calculate();" onkeypress="IsNumeric1(event); preventDot(event);"
