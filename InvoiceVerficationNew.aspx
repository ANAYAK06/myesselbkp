<%@ Page Title="" Language="C#" MasterPageFile="~/Essel.master" AutoEventWireup="true"
    CodeFile="InvoiceVerficationNew.aspx.cs" Inherits="InvoiceVerficationNew" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        var cesstaxes = 0;
        function validate() {
            var objs = new Array("<%=txtindt.ClientID %>", "<%=txtindtmk.ClientID %>");
            if (!CheckInputs(objs)) {
                return false;
            }
    ...
    <script type="text/javascript">
        ...
        function checkDatemake(sender, args) {
            //debugger;
            var today = new Date();
            var dd = today.getDate();
            var mm = today.getMonth() + 1; //January is 0!
                    ...
                    <tr>
                        <td valign="top" align="center">
                            <div class="box-a list-a">
                                <div class="inner">
                                    <table id="_terp_list" class="gridview" width="750px" cellspacing="0" cellpadding="0">
                                        <tbody>
                                            <tr>
                                                        ...
                                                        <ContentTemplate>
                                                            <div class="box-a list-a">
                                                                <div class="inner" align="center">
                                                                    <table id="Table2" class="gridview" width="750px" cellspacing="0" cellpadding="0">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td class="grid-content" align="center">
                                                                                    <table id="_terp_list_grid" class="grid" width="100%" cellspacing="0" align="center"
                                                                                        ...
                                                                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="grid-content"
                                                                                            ...
                                                                                            AllowPaging="false" DataKeyNames="invoiceno,po_no,cc_code,id" OnRowEditing="GridView1_RowEditing"
                                                                                            BorderColor="White" EmptyDataText="There is no records" OnRowDeleting="GridView1_RowDeleting1">
                                                                                            <%--OnRowDeleting="GridView1_RowDeleting1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"--%>
                                                                                            <Columns>
                                                                                                <asp:CommandField ButtonType="Image" HeaderText="View" ShowEditButton="true" EditImageUrl="~/images/iconset-b-edit.gif" />
                                                                    ...
                                                                    <table id="tblinvoiceverification" runat="server" class="estbl" width="750px">
                                                                        <tr>
                                                                            <td colspan="6">
                                                                                <table class="estbl" width="750px">
                                                                                    <tr>
                                                                                        <th align="center" colspan="6">
                                                                                            Service Provider Invoice Verification
                                                                                        </th>
                                                                                    </tr>
                                                                                    <tr id="paytype" runat="server">
                                                                                        <td colspan="6">
                                                                                            <table class="innertab" width="750px">
                                                                                                <tr>
                                                                                                    <td style="width: 200px; font-size: 10px">
                                                                                                        Vendor Id:
                                                                                                    </td>
                                                                                                    <td>
                                                                                                        <asp:TextBox ID="lblvenid" Width="80px" ReadOnly="true" onKeyPress="javascript: return false;"
                                                                                                            onKeyDown="javascript: return false;" Font-Size="10px" runat="server"> </asp:TextBox>
                                                                                                    </td>
                                                                                                    <td style="width: 200px; font-size: 10px">
                                                                                                        Vendor Name:
                                                                                                    </td>
                                                                                                    <td>
                                                                                                        <asp:TextBox ID="lblvendorname" Width="200px" ReadOnly="true" onKeyPress="javascript: return false;"
                                                                                                            onKeyDown="javascript: return false;" Font-Size="10px" runat="server"> </asp:TextBox>
                                                                                                    </td>
                                                                                                    ...
                                                                                                    <td>
                                                                                                        <asp:TextBox ID="lblpono" Width="80px" ReadOnly="true" onKeyPress="javascript: return false;"
                                                                                                            onKeyDown="javascript: return false;" Font-Size="10px" runat="server"> </asp:TextBox>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </table>
                                                                                                    ...
                                                                                                    <td colspan="6">
                                                                                                        <table width="100%" style="border-style: hidden;">
                                                                                                            <tr style="border-style: hidden;">
                                                                                                                <td style="border-style: hidden; font-weight: normal" colspan="2">
                                                                                                                    <asp:Label ID="Label1" runat="server" CssClass="eslbl" Font-Size="10px" Text="Inv No:"></asp:Label>
                                                                                                                       <asp:TextBox ID="lblinvno" Width="150px" ReadOnly="true" onKeyPress="javascript: return false;"
                                                                                                                        onKeyDown="javascript: return false;" runat="server"> </asp:TextBox>
                                                                                                                </td>                                                                                                             
                                                                                                                ...
                                                                                                                <td style="border-style: hidden;">
                                                                                                                    <asp:TextBox ID="txtindt" CssClass="estbox" runat="server" onKeyDown="preventBackspace();"
                                                                                                                        onpaste="return false;" onkeypress="return false;" Font-Size="10px" ToolTip="Invoice Date"
                                                                                                                ...
                                                                                                                <td style="border-style: hidden;">
                                                                                                                    <asp:TextBox ID="txtindtmk" CssClass="estbox" runat="server" onKeyDown="preventBackspace();"
                                                                                                                        onpaste="return false;" onkeypress="return false;" Font-Size="10px" ToolTip="Invoice Making Date"
                                                                                                                        Width="85px"></asp:TextBox>
                                                                                                                    <cc1:CalendarExtender ID="CalendarExtender3" runat="server" TargetControlID="txtindtmk"
                                                                                                                        CssClass="cal_Theme1" Format="dd-MMM-yyyy" FirstDayOfWeek="Monday" Animated="true"
                                                                                                                        OnClientDateSelectionChanged="checkDatemake" PopupButtonID="txtindtmk">
                                                                                                                    </cc1:CalendarExtender>
                                                                                                                </td>
                                                                                                                <td style="border-style: hidden; font-weight: normal">
                                                                                                                ...
                                                                                                                <td style="border-style: hidden;">
                                                                                                                    <asp:TextBox ID="txtbasic" CssClass="estbox" runat="server" Font-Size="10px" ToolTip="Basic Value"
                                                                                    ...
                                                                                    <tr id="trtaxes" runat="server">
                                                                                        <td colspan="6">
                                                                                            <table id="tblgridtaxes" runat="server" class="innertab" align="center" width="750px">
                                                                                                <tr align="left" id="trtaxbtns" runat="server">
                                                                                                ...
                                                                                                <tr align="right">
                                                                                                    <td colspan="6" style="font-weight: normal">
                                                                                                        ...
                                                                                                        <asp:TextBox ID="lbltaxes" CssClass="estbox" Font-Size="10px" runat="server" onKeyPress="javascript: return false;"
                                                                                    ...
                                                                                    <tr id="trcess" runat="server">
                                                                                        <td colspan="6">
                                                                                            <table id="tblgridcess" runat="server" class="innertab" align="center" width="750px">
                                                                                                <tr align="left" id="trbtncess" runat="server">
                                                                                                    <td colspan="6" align="left">
                                                                                                ...
                                                                                                <tr align="right">
                                                                                                    <td colspan="6" style="font-weight: normal">
                                                                                                        ...
                                                                                                        <asp:TextBox ID="txtcess" CssClass="estbox" Font-Size="10px" runat="server" onKeyPress="javascript: return false;"
                                                                                                            onKeyDown="javascript: return false;" Text="0" Width="50px"></asp:TextBox>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </table>
                                                                                            ...
                                                                                            <table id="Table1" runat="server" class="innertab" align="center" width="750px">
                                                                                                    ...
                                                                                                    <td colspan="6">
                                                                                                        <asp:GridView runat="server" ID="gvother" HeaderStyle-HorizontalAlign="Center" AlternatingRowStyle-CssClass="grid-row grid-row-even"
                                                                                                            ...
                                                                                                            <Columns>
                                                                                                                ...
                                                                                                                <asp:CommandField ShowDeleteButton="true" DeleteText="Remove" ItemStyle-Width="50px" />
                                                                                                            </Columns>
                                                                                                            <RowStyle CssClass=" grid-row char grid-row-odd" HorizontalAlign="Center" />
                                                                                                            <PagerStyle CssClass="grid pagerbar" />
                                                                                                            <HeaderStyle CssClass="grid-header" />
                                                                                                ...
                                                                                                <tr align="right">
                                                                                                    <td colspan="6" style="font-weight: normal">
                                                                                                        ...
                                                                                                        <asp:TextBox ID="txtother" CssClass="estbox" Font-Size="10px" runat="server" onKeyPress="javascript: return false;"
                                                                                                            onKeyDown="javascript: return false;" Text="0" Width="50px"></asp:TextBox>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </table>
                                                                                            ...
                                                                                            <table id="Table3" runat="server" class="innertab" align="center" width="750px">
                                                                                                ...
                                                                                                <tr align="right">
                                                                                                    <td colspan="6" style="font-weight: normal">
                                                                                                        ...
                                                                                                        <asp:TextBox ID="txtdeduction" CssClass="estbox" Font-Size="10px" runat="server"
                                                                                                            onKeyPress="javascript: return false;" onKeyDown="javascript: return false;"
                                                                                                            Text="0" Width="50px"></asp:TextBox>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </td>
