<%@ Page Title="Vendor Consolidate Purchase Report - Essel Projects Pvt.Ltd." Language="C#" MasterPageFile="~/Essel.master" AutoEventWireup="true" CodeFile="VendorConsolidatePurchaseReport.aspx.cs" Inherits="VendorConsolidatePurchaseReport" %>
                                    ...
                                    <table class="estbl" width="700px">
                                        <tr style="border: 1px solid #000">
                                            <th valign="top" colspan="5" align="center">
                                                <asp:Label ID="Label4" CssClass="esfmhead" runat="server" Text="VIEW ITEMS PURCHASE CONSOLIDATE REPORT"></asp:Label>
                                            </th>
                                        </tr>
                            ...
                            <tr>
                                <td align="center">
                                    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            <asp:BoundField DataField="ComanyGSTIN" HeaderText="Our GSTIN" ItemStyle-HorizontalAlign="Center"
                                            ...
                                            <asp:BoundField DataField="SupplierGSTIN" HeaderText="GSTIN" ItemStyle-HorizontalAlign="Center" />
                                            <asp:BoundField DataField="InvoiceNo" HeaderText="InvoiceNo" ItemStyle-HorizontalAlign="Center"
                                                HeaderStyle-Wrap="false" ItemStyle-Wrap="false" />
                                            <asp:BoundField DataField="Invoice_Date" DataFormatString="{0:dd-MMM-yyyy}" HeaderText="Invoice Date"
                                                ItemStyle-Wrap="false" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Left" />                                           
                                            <asp:BoundField DataField="InvoiceAmount" HeaderText="Invoice Amount" ItemStyle-HorizontalAlign="Right"
                                                HeaderStyle-Wrap="false" ItemStyle-Wrap="false" DataFormatString="{0:F2}" />                                          
                                            <asp:BoundField DataField="IGST" HeaderText="IGST Amt" ItemStyle-HorizontalAlign="Right"
                                                HeaderStyle-Wrap="false" ItemStyle-Wrap="false" DataFormatString="{0:n2}" />
                                            <asp:BoundField DataField="CGST" HeaderText="CGST Amt" ItemStyle-HorizontalAlign="Right"
                                                HeaderStyle-Wrap="false" ItemStyle-Wrap="false" DataFormatString="{0:F2}" />                                          
                                            <asp:BoundField DataField="SGST" HeaderText="SGST Amt" ItemStyle-HorizontalAlign="Right"
                                                HeaderStyle-Wrap="false" ItemStyle-Wrap="false" DataFormatString="{0:F2}" />
                                             <asp:BoundField DataField="Other" HeaderText="Other" ItemStyle-HorizontalAlign="Right"
                                                HeaderStyle-Wrap="false" ItemStyle-Wrap="false" DataFormatString="{0:F2}" />
                                             <asp:BoundField DataField="Deduction" HeaderText="Deduction" ItemStyle-HorizontalAlign="Right"
                                                HeaderStyle-Wrap="false" ItemStyle-Wrap="false" DataFormatString="{0:F2}" />
                                             <asp:BoundField DataField="Frieght" HeaderText="Frieght" ItemStyle-HorizontalAlign="Right"
                                                HeaderStyle-Wrap="false" ItemStyle-Wrap="false" DataFormatString="{0:F2}" />
